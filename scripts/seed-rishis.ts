/**
 * Seed all 16 rishi profiles into Sanity.
 * Run: npm run seed:rishis
...
interface RishiDoc {
  ...
  lineage: string
  disciples: string
  keyCompositions: KeyComposition[]
}

const rishis: RishiDoc[] = [
  {
    _type: 'rishi',
    _id: 'rishi-vishvamitra',
    name: 'Vishvamitra',
    slug: { current: 'vishvamitra' },
    ...
    keyCompositions: [
      { _type: 'object', _key: 'kc1', title: 'Gayatri Mantra', reference: 'Rigveda 3.62.10', description: 'The most sacred verse in Vedic literature. A prayer to the divine light of Savitri. Chanted at dawn, noon, and dusk by millions every single day for over 4000 years.' },
  ...
  },
  {
    ...
    keyCompositions: [
      ...
      { _type: 'object', _key: 'kc2', title: 'Yoga Vasistha', reference: 'Philosophical text', description: 'A vast text recording teachings to Rama on consciousness, maya, and liberation. One of the most profound Sanskrit philosophical works.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    famousVerseTranslation: 'Two birds, bound together as companions, clasp the same tree. One of them eats the sweet fruit; the other looks on without eating.',
    famousVerseSource: 'Rigveda 1.164.20 — later quoted in the Mundaka and Shvetashvatara Upanishads',
    lineage: 'Angirasa family',
    disciples: 'His sons carried on the Gautama lineage',
    keyCompositions: [
      { _type: 'object', _key: 'kc1', title: 'The Riddle Hymn', reference: 'Rigveda 1.164', description: 'A 52-verse hymn of cosmological riddles. The two-birds verse (1.164.20) became one of the most quoted in all Upanishadic philosophy.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    disciples: '—',
    keyCompositions: [
      { _type: 'object', _key: 'kc1', title: 'Dialogue Hymn', reference: 'Rigveda 1.179', description: "A conversation between Lopamudra and Agastya on desire, dharma, and the householder's path. Two great minds speaking as equals." },
    ],
  },
  {
    _type: 'rishi',
    ...
    summary: 'Jaimini systematised the Samaveda tradition and founded Purva Mimamsa — the philosophical school that analyses the eternal validity of the Vedas and the nature of dharmic duty. His Mimamsa Sutras remain the most thorough examination of Vedic ritual obligation ever composed.',
    famousVerse: 'चोदना लक्षणोऽर्थो धर्मः ॥',
    famousVerseTranslation: 'Dharma is that whose character is the injunction of the Vedas.',
    famousVerseSource: 'Mimamsa Sutra 1.1.2 — the foundational definition of dharma in the Mimamsa school',
    ...
    keyCompositions: [
      ...
      { _type: 'object', _key: 'kc2', title: 'Jaimini Bharata', reference: 'Epic tradition', description: 'A version of the Mahabharata composed by Jaimini from the Samaveda perspective.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    keyCompositions: [
      { _type: 'object', _key: 'kc1', title: 'Classification of the Four Vedas', reference: 'Vedic canon', description: 'Organised the single primordial Veda into Rigveda, Samaveda, Yajurveda, and Atharvaveda and assigned each to a disciple.' },
      ...
      { _type: 'object', _key: 'kc3', title: 'Srimad Bhagavatam', reference: '18,000 verses', description: "Composed at the instruction of Narada as Vyasa's final and most complete work — the crown jewel of Puranic literature." },
      { _type: 'object', _key: 'kc4', title: 'Brahma Sutras', reference: 'Vedanta Sutras', description: '555 sutras systematising the teaching of the Upanishads. Commented upon by Shankara, Ramanuja, and Madhva.' },
    ],
  },
  {
    _type: 'rishi',
    _id: 'rishi-kauthuma',
    name: 'Kauthuma',
    slug: { current: 'kauthuma' },
    devanagari: 'कौथुम',
    transliteration: 'Kauthuma',
    vedaAssociation: 'samaveda',
    period: '~2500 BCE',
    epithet: 'Founder of the most widespread living school of the Samaveda',
    summary: 'Kauthuma founded the Kauthuma shakha — the most widely practised school of the Samaveda, still actively chanted today in Gujarat, Maharashtra, and parts of Tamil Nadu. His lineage represents one of the last living connections to the original Samavedic musical tradition.',
    ...
    keyCompositions: [
      { _type: 'object', _key: 'kc1', title: 'Kauthuma Samhita', reference: 'Samaveda recension', description: 'The most widely transmitted recension of the Samaveda — 1,875 verses with full musical notation. Still chanted in its original form today.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    summary: 'Narada is the great cosmic wanderer — a devarishi who travels ceaselessly across the three worlds with his vina, singing the names of Vishnu. He transmitted the musical tradition of the Samaveda to humanity and appears throughout the Puranas as catalyst, guide, and divine messenger.',
    famousVerse: 'नारायण नारायण ।',
    famousVerseTranslation: 'Narayana, Narayana — the eternal chant of the divine name that Narada carries across all the worlds.',
    ...
    keyCompositions: [
      { _type: 'object', _key: 'kc1', title: 'Narada Bhakti Sutras', reference: '84 sutras', description: 'The most important text on the philosophy of devotion (bhakti) — 84 sutras defining, analysing, and celebrating love of the divine.' },
      { _type: 'object', _key: 'kc2', title: 'Naradiya Shiksha', reference: 'Samaveda phonetics', description: 'A foundational text on Vedic phonetics and the proper chanting of the Samaveda — preserving the exact tonal system.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    keyCompositions: [
      { _type: 'object', _key: 'kc1', title: 'Brihadaranyaka Upanishad', reference: 'Shukla Yajurveda', description: 'Oldest and largest Upanishad. Contains Neti Neti, the Maitreyi dialogue, and Madhu Vidya. Foundation of all Advaita Vedanta.' },
      { _type: 'object', _key: 'kc2', title: 'Shukla Yajurveda', reference: 'Vajasaneyi Samhita', description: 'Received directly from Surya in the form of a horse — hence called Vajasaneya (of the horse). Kept mantras and commentary separate.' },
      { _type: 'object', _key: 'kc3', title: 'Yajnavalkya Smriti', reference: 'Dharmashastra', description: 'Most authoritative text on dharmic law. Commentated by Vijnanesvara in the famous Mitakshara — still cited in Indian courts today.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    name: 'Baudhayana',
    slug: { current: 'baudhayana' },
    devanagari: 'बौधायन',
    transliteration: 'Baudhāyana',
    vedaAssociation: 'yajurveda',
    period: '~800 BCE',
    epithet: 'Author of the Pythagorean theorem — 1,000 years before Pythagoras',
    summary: 'Baudhayana composed the Baudhayana Shulba Sutra — containing the theorem now known as the Pythagorean theorem over a thousand years before Pythagoras was born. His fire altar geometry instructions encode pi, Pythagorean triples, and astronomical cycles in precise brick arrangements.',
    ...
    keyCompositions: [
      ...
      { _type: 'object', _key: 'kc2', title: 'Baudhayana Dharmasutra', reference: 'Dharmashastra', description: 'One of the oldest surviving dharmasutras — rules for the Brahmin student, householder, forest-dweller, and renunciant.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    keyCompositions: [
      ...
      { _type: 'object', _key: 'kc2', title: 'Mahabharata recitation', reference: 'At the Sarpa Satra', description: "Vaishampayana recited the entire Mahabharata at King Janamejaya's serpent sacrifice — the primary occasion of its transmission to the world." },
    ],
  },
  {
    _type: 'rishi',
    _id: 'rishi-tittiri',
    name: 'Tittiri',
    slug: { current: 'tittiri' },
    devanagari: 'तित्तिरि',
    transliteration: 'Tittiri',
    vedaAssociation: 'yajurveda',
    period: '~3000 BCE',
    epithet: 'Namesake of the Taittiriya school — the most vibrant living Yajurvedic tradition',
    summary: 'Tittiri was a disciple of Vaishampayana whose name became attached to the most widely practised school of the Black Yajurveda — the Taittiriya shakha. The Taittiriya Samhita, Brahmana, Aranyaka, and Upanishad all carry his name and remain actively chanted and studied today.',
    famousVerse: 'सह नाववतु । सह नौ भुनक्तु ।\nसह वीर्यं करवावहै ।\nतेजस्वि नावधीतमस्तु\nमा विद्विषावहै ॥',
    famousVerseTranslation: 'May we be protected together, may we be nourished together, may we work together with great energy. May our study be luminous. May we not be hostile to each other.',
    ...
    keyCompositions: [
      ...
      { _type: 'object', _key: 'kc2', title: 'Taittiriya Upanishad', reference: 'Vedanta', description: 'Contains the Brahmananda Valli — teaching that Brahman is ananda (bliss). One of the most studied Upanishads in the living tradition.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    keyCompositions: [
      { _type: 'object', _key: 'kc1', title: 'Atharvaveda (core hymns)', reference: 'Atharvan lineage', description: 'The foundational hymns of the Atharvaveda trace to the Atharvan lineage — fire rituals, healing, protection, and cosmic philosophy.' },
    ],
  },
  {
    _type: 'rishi',
    _id: 'rishi-angiras',
    name: 'Angiras',
    slug: { current: 'angiras' },
    devanagari: 'अङ्गिरस्',
    transliteration: 'Aṅgiras',
    vedaAssociation: 'atharvaveda',
    period: 'Primordial',
    epithet: 'Co-founder of the Atharvagirasas — seer of cosmic philosophy and astronomy',
    summary: 'Angiras is one of the seven eternal rishis (Saptarishis) and co-founder of the Atharvaveda tradition alongside Atharvan. The Atharvaveda was originally called the Atharvagirasas — of Atharvan and Angiras. His lineage contributed the cosmological, astronomical, and philosophical hymns.',
    ...
    keyCompositions: [
      ...
      { _type: 'object', _key: 'kc2', title: 'Angirasa hymns', reference: 'Rigveda', description: 'The Angirasa family composed significant portions of the Rigveda as well — their hymns span both major Vedic collections.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    famousVerse: 'काश्यप उवाच —\nकस्मिन् विज्ञाते सर्वमिदं\nविज्ञातं भवति ॥',
    famousVerseTranslation: 'Kashyapa asked: By knowing what, is all this known?',
    famousVerseSource: 'Mundaka Upanishad 1.1.3 — from the Atharvaveda, framing the quest for the knowledge of Brahman',
    ...
    keyCompositions: [
      ...
      { _type: 'object', _key: 'kc2', title: 'Brihaddevata', reference: 'Vedic encyclopaedia', description: 'A complete guide to all Vedic deities — which deity is addressed in each hymn, their mythology, and their relationships. An indispensable reference for Vedic studies.' },
    ],
  },
  {
    _type: 'rishi',
    ...
    keyCompositions: [
      { _type: 'object', _key: 'kc1', title: 'Paippalada Samhita', reference: 'Atharvaveda', description: 'Contains unique hymns not found in the Shaunaka recension. Long thought lost — manuscripts recovered in Kashmir and Odisha in the 20th century.' },
    ],
  },
]
...
async function seed() {
  console.log(`\nSeeding ${rishis.length} rishi profiles into Sanity...\n`)

  let successes = 0
  let failures = 0

  for (const rishi of rishis) {
    try {
      await client.createOrReplace(rishi)
      console.log(`✓  ${rishi.name} (${rishi._id})`)
      successes++
    } catch (err) {
      const message = err instanceof Error ? err.message : String(err)
      console.error(`✗  ${rishi.name} (${rishi._id}): ${message}`)
      failures++
    }
  }

  console.log(`\n─────────────────────────────────`)
  console.log(`✓  ${successes} seeded successfully`)
  if (failures > 0) {
