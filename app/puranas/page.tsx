...
export default function PuranasPage() {
  return (
    <main>
      {/* Zone 1 — Page header */}
      <div className="bg-sandal-100 px-6 py-6 border-b border-[rgba(192,120,40,0.20)]">
        <p className="text-overline text-saffron-500 mb-2 uppercase tracking-widest">
          PURĀṆA CANON · SMṚTI · 18 MAHĀPURĀṆAS
        </p>
        <h1 className="font-serif text-display-sm text-ink mb-2">The Eighteen Mahāpurāṇas</h1>
        <p className="text-body-sm text-ink-muted max-w-[520px] mb-4">
        ...
        {/* Tier key */}
        <div className="bg-white border border-[rgba(192,120,40,0.18)] rounded-lg px-4 py-3 flex flex-wrap items-center gap-x-5 gap-y-2">
