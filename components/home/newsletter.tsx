export function NewsletterSignup() {
  return (
    <section className="w-full bg-sandal-100 py-14 md:py-20">
      <div className="mx-auto max-w-wide rounded-xl bg-saffron-50 p-8 px-4 text-center sm:px-6 md:p-10 lg:px-8">
      ...
      >
        ...
        <input
          ...
          className="w-full rounded-sm border border-[rgba(192,120,40,0.30)] bg-sandal-100 px-3 py-2 text-body-sm text-ink placeholder:text-ink-faint focus:outline-none focus:ring-2 focus:ring-saffron-400"
        />
        <button
          type="submit"
